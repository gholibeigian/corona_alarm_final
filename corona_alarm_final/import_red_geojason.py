...
class Input_red_geojason:
    ...
    def load_red_geojason(self):
        with open('polygon_geojason/red.geojason', 'r') as reader:
            # self.text.()
    ...
    def save(self):
        with open('polygon_geojason/red.geojason', 'w') as writer:
